CAPTURA DE LABORATORIO DICIB // WIRESHARK CTF

Archivo: DICIB-CAPTURE.pcap.gz
...
- Para empezar: usar el filtro http y despues filtrar por la IP del equipo.
- No contiene trafico de Internet ni credenciales reales.
